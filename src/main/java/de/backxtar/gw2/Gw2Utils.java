    ...
    public static String currency(int id, long amount) {
        ...
        switch (id) {
            case 1 : long[] coins = getCoins(amount);
                currency = "╰ [color=" + Config.getColors().mainColor + "][b]Coins:[/b][/color] " + (coins[2] > 0 ? "[b]" + coins[2] + "[/b] Gold, " : "") +
                        (coins[1] > 0 ? "[b]" + coins[1] + "[/b] Silber, " : "") +
                        (coins[0] > 0 ? "[b]" + coins[0] + "[/b] Kupfer" : "");
                break;
            case 2 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Karma:[/b][/color] " + amount;
                break;
            case 3 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Lorbeeren:[/b][/color] " + amount;
                break;
            case 4 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Edelsteine:[/b][/color] " + amount;
                break;
            case 5 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Ascalonische Tränen:[/b][/color] " + amount;
                break;
            case 6 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Scherben des Zhaitan:[/b][/color] " + amount;
                break;
            case 7 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Fraktal-Relikte:[/b][/color] " + amount;
                break;
            case 9 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Beetletuns Siegel:[/b][/color] " + amount;
                break;
            case 10 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Manifeste des Maulwetariats:[/b][/color] " + amount;
                break;
            case 11 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Tödliche Blüten:[/b][/color] " + amount;
                break;
            case 12 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Symbole Kodas:[/b][/color] " + amount;
                break;
            case 13 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Flammen-Legion-Charr-Schnitzereien:[/b][/color] " + amount;
                break;
            case 14 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Wissenskristalle:[/b][/color] " + amount;
                break;
            case 15 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Ehrenabzeichen:[/b][/color] " + amount;
                break;
            case 16 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Gilden-Belobigungen:[/b][/color] " + amount;
                break;
            case 18 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Transmutation-Ladungen:[/b][/color] " + amount;
                break;
            case 19 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Luftschiff-Teile:[/b][/color] " + amount;
                break;
            case 20 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Ley-Linien-Kristalle:[/b][/color] " + amount;
                break;
            case 22 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Aurilliumklumpen:[/b][/color] " + amount;
                break;
            case 23 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Geister-Scherben:[/b][/color] " + amount;
                break;
            case 24 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Makelloses Fraktal-Relikte:[/b][/color] " + amount;
                break;
            case 25 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Geoden:[/b][/color] " + amount;
                break;
            case 26 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]WvW-Gefecht-Tickets:[/b][/color] " + amount;
                break;
            case 27 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Banditen-Wappen:[/b][/color] " + amount;
                break;
            case 28 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Magnetitscherben:[/b][/color] " + amount;
                break;
            case 29 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Versorger-Marken:[/b][/color] " + amount;
                break;
            case 30 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]PvP-Liga-Tickets:[/b][/color] " + amount;
                break;
            case 31 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Beweise der Heldentaten:[/b][/color] " + amount;
                break;
            case 32 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Aufgestiegene Scherben des Ruhms:[/b][/color] " + amount;
                break;
            case 33 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Entfesselte Magie:[/b][/color] " + amount;
                break;
            case 34 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Handelsverträge:[/b][/color] " + amount;
                break;
            case 35 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Elegie-Mosaike:[/b][/color] " + amount;
                break;
            case 36 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Zeugnisse von Heldentaten:[/b][/color] " + amount;
                break;
            case 37 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Erhabene-Schlüssel:[/b][/color] " + amount;
                break;
            case 38 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Macheten:[/b][/color] " + amount;
                break;
            case 39 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Gaets-Kristalle:[/b][/color] " + amount;
                break;
            case 40 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Banditen-Dietriche:[/b][/color] " + amount;
                break;
            case 41 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Pakt-Brechstangen:[/b][/color] " + amount;
                break;
            case 42 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Phiolen Chak-Säure:[/b][/color] " + amount;
                break;
            case 43 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Zephyriten-Dietriche:[/b][/color] " + amount;
                break;
            case 44 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Schlüssel des Händlers:[/b][/color] " + amount;
                break;
            case 45 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Flüchtige Magie:[/b][/color] " + amount;
                break;
            case 46 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]PvP-Turnier-Gutscheine:[/b][/color] " + amount;
                break;
            case 47 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Renn-Medaillen:[/b][/color] " + amount;
                break;
            case 49 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Nebelgeborenere Schlüssel:[/b][/color] " + amount;
                break;
            case 50 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Festmarken:[/b][/color] " + amount;
                break;
            case 51 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Lager-Schlüssel:[/b][/color] " + amount;
                break;
            case 52 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Rote Propheten-Scherben:[/b][/color] " + amount;
                break;
            case 53 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Grüne Propheten-Scherben:[/b][/color] " + amount;
                break;
            case 54 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Blauer Propheten-Kristalle:[/b][/color] " + amount;
                break;
            case 55 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Grüner Propheten-Kristalle:[/b][/color] " + amount;
                break;
            case 56 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Roter Propheten-Kristalle:[/b][/color] " + amount;
                break;
            case 57 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Blaue Propheten-Scherben:[/b][/color] " + amount;
                break;
            case 58 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Kriegs-Vorräte:[/b][/color] " + amount;
                break;
            case 59 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Instabile Fraktal-Essenzen:[/b][/color] " + amount;
                break;
            case 60 : currency = "╰ [color=" + Config.getColors().mainColor + "][b]Tyrianische Verteidigungssiegel:[/b][/color] " + amount;
                break;
        }
        return currency;
    }
